...
begin
 D2BridgeServerController:= TAPSFSIWEBWebAppGlobal.Create(TApplication.Create(nil));
 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort(8888);
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('APS_FSI_WEB');

 D2BridgeServerController.APPName:= 'APSFSIWEB';
